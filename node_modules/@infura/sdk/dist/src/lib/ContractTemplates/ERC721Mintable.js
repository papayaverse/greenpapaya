...
var ERC721Mintable_1 = __importDefault(require("./artifacts/ERC721Mintable"));
...
var ERC721Mintable = /** @class */ (function () {
    function ERC721Mintable(signer) {
     ...
     */
    ERC721Mintable.prototype.deploy = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (this.contractAddress || this.contractDeployed) {
                            Logger_1.log.throwArgumentError(Logger_1.Logger.message.contract_already_deployed, 'contractAddress', this.contractAddress, {
                                location: Logger_1.Logger.location.ERC721MINTABLE_DEPLOY,
                            });
                        }
                        if (!this.signer) {
                    ...
                    case 1:
                        _b.trys.push([1, 4, , 5]);
                        factory = new ethers_1.ethers.ContractFactory(ERC721Mintable_1.default.abi, ERC721Mintable_1.default.bytecode, this.signer);
     ...
     */
    ERC721Mintable.prototype.mint = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var options;
     ...
     */
    ERC721Mintable.prototype.loadContract = function (params) {
        if (this.contractAddress || this.contractDeployed) {
            Logger_1.log.throwArgumentError(Logger_1.Logger.message.contract_already_deployed, 'contractAddress', this.contractAddress, {
                location: Logger_1.Logger.location.ERC721MINTABLE_LOADCONTRACT,
            });
        }
        ...
        try {
            ...
            this.contractDeployed = new ethers_1.ethers.Contract(this.contractAddress, ERC721Mintable_1.default.abi, this.signer);
            this.royalty.setContract(this.contractDeployed);
            this.accessControl.setContract(this.contractDeployed);
            this.baseERC721.setContract(this.contractDeployed);
            return this;
     ...
     * @returns {Promise<ethers.providers.TransactionResponse>} Transaction
     */
    ERC721Mintable.prototype.setContractURI = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var options;
            return __generator(this, function (_a) {
                if (!this.contractDeployed && !this.contractAddress) {
                    Logger_1.log.throwArgumentError(Logger_1.Logger.message.contract_not_deployed, 'contractAddress', this.contractAddress, {
                        location: Logger_1.Logger.location.ERC721MINTABLE_SET_CONTRACT_URI,
                    });
                }
...
exports.default = ERC721Mintable;
//# sourceMappingURL=ERC721Mintable.js.map