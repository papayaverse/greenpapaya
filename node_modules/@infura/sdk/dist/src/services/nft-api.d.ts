...
export interface Components {
    schemas: {
        ...
        TransfersModel: {
             ...
             * @enum {string}
             */
            network: 'ETHEREUM' | 'GOERLI' | 'SEPOLIA' | 'BSC' | 'POLYGON' | 'MUMBAI' | 'BSC TESTNET' | 'AVALANCHE' | 'AVALANCHE TESTNET' | 'FANTOM' | 'CRONOS' | 'CRONOS TESTNET' | 'PALM' | 'ARBITRUM';
            cursor: string;
            /** @example 0x0a267cf51ef038fc00e71801f5a524aec06e4f07 */
            account: string;
...
//# sourceMappingURL=nft-api.d.ts.map